...
# from round_key.matrizes import matriz_para_array
# from expansion import aes_key_expansion
...
# # Frase em português
# frase = "bomdiabrasilllll"

# # Converte a frase em bytes usando a codificação UTF-8
# bytes_frase = frase.encode('utf-8')
# print(bytes_frase)

# # Converte os bytes em uma string hexadecimal
# hex_string = bytes_frase.hex()

# print(hex_string)

# #print(matriz_para_array(matriz_chave))
# #print(expanded_key = aes_key_expansion(array_chave))
...
aes_python = AES(texto)

print(aes_python.encrypt(texto))
